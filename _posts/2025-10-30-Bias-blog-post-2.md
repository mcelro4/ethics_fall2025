...
Who should be held reliable when there is harm in AI systems? Model developers, Analysts, Managers, outputters? Is the accountability directed towards one group or spread throughout each branch?
...
These sources of harm could have manifested during my machine learning class last semester, specifically learning bias. We had homeworks where we looked at specific objectives in data like accuracy, precision etc. Focusing on one objective may have caused me and my classmates to overlook another objective leading to learning bias.

My question:

What are ways that users can give feedback on harmful biases that they encounter when engaging in Machine learning pipelines/ systems.

Answer: Users could stop using the system when Machine learning systems produce harmful biases. They could also reach out to the company or if they can the developers and mention the harmful biases that are seen. Additionally, social media impacts the way people communicate and spread information. Sharing personal experiences with harmful biases could lead to change.
